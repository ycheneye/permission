    ...
    <div class="navbar-container">
        ...
        <div class="navbar-buttons navbar-header pull-right" role="navigation">
            <ul class="nav ace-nav">
                <li class="light-blue dropdown-modal open">
                    <a data-toggle="dropdown" href="javascript:void(0)" class="dropdown-toggle" aria-expanded="true">
                        <span class="user-info">
                            <small>欢迎,</small>${loggingUser.username}
                        </span>
                        <%--<i class="ace-icon fa fa-caret-down"></i>--%>
                    </a>
                </li>
                <li class="light-red dropdown-modal">
                <a href="/logout.page">

                        <i class="ace-icon fa fa-power-off"></i>
                        <span class="user-info" style="line-height: 28px">
                            注销
                        </span>
